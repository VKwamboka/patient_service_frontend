...
import { ToISOTimeOptions, ToISOFormat, ToSQLOptions, ToRelativeOptions, ToRelativeCalendarOptions, SetZoneOptions, GregorianDateTime, GenericDateTime, GenericDateTimePlurals, DateTimeOptions, ExplainedFormat } from "./types/datetime";
...
export declare class DateTime {
     ...
     * @return {number}
     */
    get(unit: string): string | number | boolean | void | Zone | ((zone: ZoneLike, { keepLocalTime, keepCalendarTime }?: SetZoneOptions) => DateTime) | Locale | ((values: GenericDateTime | GenericDateTimePlurals) => DateTime) | (() => number) | (({ format, suppressSeconds, suppressMilliseconds, includeOffset, extendedZone }?: ToISOTimeOptions) => string | null) | ((otherDateTime: DateTime, unit?: DurationUnit | DurationUnit[], opts?: DurationOptions) => Duration) | ((duration: DurationLike | number) => DateTime) | ((unit: DurationUnit, { useLocaleWeeks }?: {
        useLocaleWeeks?: boolean;
    }) => DateTime) | ((duration: DurationLike | number) => DateTime) | (() => string) | ((formatOpts?: Intl.DateTimeFormatOptions & LocaleOptions, opts?: DateTimeOptions) => string) | ((other: DateTime) => boolean) | ((unit?: DurationUnit | DurationUnit[], opts?: DurationOptions) => Duration) | ((unit: DurationUnit, { useLocaleWeeks }?: {
        useLocaleWeeks?: boolean;
    }) => DateTime) | ((unit: string) => string | number | boolean | void | Zone | ((zone: ZoneLike, { keepLocalTime, keepCalendarTime }?: SetZoneOptions) => DateTime) | Locale | ((values: GenericDateTime | GenericDateTimePlurals) => DateTime) | (() => number) | (({ format, suppressSeconds, suppressMilliseconds, includeOffset, extendedZone }?: ToISOTimeOptions) => string | null) | ((otherDateTime: DateTime, unit?: DurationUnit | DurationUnit[], opts?: DurationOptions) => Duration) | ((duration: DurationLike | number) => DateTime) | ((unit: DurationUnit, { useLocaleWeeks }?: {
        useLocaleWeeks?: boolean;
    }) => DateTime) | ((duration: DurationLike | number) => DateTime) | (() => string) | ((formatOpts?: Intl.DateTimeFormatOptions & LocaleOptions, opts?: DateTimeOptions) => string) | ((other: DateTime) => boolean) | ((unit?: DurationUnit | DurationUnit[], opts?: DurationOptions) => Duration) | ((unit: DurationUnit, { useLocaleWeeks }?: {
        useLocaleWeeks?: boolean;
    }) => DateTime) | /*elided*/ any | (() => DateTime[]) | ((otherDateTime: DateTime, unit: DurationUnit, opts?: {
        useLocaleWeeks?: boolean;
    }) => boolean) | ((options: LocaleOptions) => DateTime) | ((opts?: {}) => {
        locale: string;
        numberingSystem: string;
        outputCalendar: string;
    }) | ((locale: string) => DateTime) | (() => Date) | ((fmt: string, opts?: DateTimeOptions) => string) | (() => string) | (({ format }?: {
        format?: ToISOFormat;
    }) => string | null) | (({ suppressMilliseconds, suppressSeconds, includeOffset, includePrefix, extendedZone, format }?: ToISOTimeOptions) => string) | (() => string) | (() => Date) | (() => string) | (() => DateTime) | ((opts?: Intl.DateTimeFormatOptions & LocaleOptions) => Intl.DateTimeFormatPart[]) | (() => number) | ((opts?: {
        includeConfig: boolean;
    }) => GregorianDateTime & Partial<LocaleOptions>) | (() => string) | ((options?: ToRelativeOptions) => string) | ((options?: ToRelativeCalendarOptions) => string) | ((opts?: ToSQLOptions) => string) | (() => string) | (({ includeOffset, includeZone, includeOffsetSpace }?: ToSQLOptions) => string) | (() => number) | ((offset?: number, opts?: SetZoneOptions) => DateTime) | (() => number) | ((otherDateTime: DateTime) => Interval | DateTime)) | (() => DateTime[]) | ((otherDateTime: DateTime, unit: DurationUnit, opts?: {
        useLocaleWeeks?: boolean;
    }) => boolean) | ((options: LocaleOptions) => DateTime) | ((opts?: {}) => {
        locale: string;
        numberingSystem: string;
        ...
        includeConfig: boolean;
    }) => GregorianDateTime & Partial<LocaleOptions>) | (() => string) | ((options?: ToRelativeOptions) => string) | ((options?: ToRelativeCalendarOptions) => string) | ((opts?: ToSQLOptions) => string) | (() => string) | (({ includeOffset, includeZone, includeOffsetSpace }?: ToSQLOptions) => string) | (() => number) | ((offset?: number, opts?: SetZoneOptions) => DateTime) | (() => number) | ((otherDateTime: DateTime) => Interval | DateTime);
    /**
